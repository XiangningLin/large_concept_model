...
# 允许通过环境变量覆盖这些路径
export DATA_OUTPUT_DIR="${DATA_OUTPUT_DIR:-$PROJECT_ROOT/output/processed_data/tom_tracking_test}"
export CACHE_DIR="${CACHE_DIR:-$PROJECT_ROOT/output/preprocessed_data}"
